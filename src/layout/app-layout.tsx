...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['lottery-manager', 'business-owner', 'team-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Lotteries', path: '/lotteries', entity: 'lottery', service: AccessServiceEnum.PROJECT, icon: FiGift },
