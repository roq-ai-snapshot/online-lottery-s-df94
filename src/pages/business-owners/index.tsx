...
export function BusinessOwnerListPage(props: BusinessOwnerListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['business_name.contains', 'business_description.contains', 'business_location.contains'],
          ...params.filters,
        },
        'business_owner',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'business_description', header: 'Business Description', accessorKey: 'business_description' },
    { id: 'business_location', header: 'Business Location', accessorKey: 'business_location' },
