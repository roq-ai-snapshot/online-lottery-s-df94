...
import { useTeamCount, useBusinessOwnerCount, useLotteryCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const lotteryStat = useLotteryCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Lotteries',
      result: lotteryStat?.data,
      isLoading: lotteryStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
