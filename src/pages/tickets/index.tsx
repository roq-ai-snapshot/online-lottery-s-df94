...
export function TicketListPage(props: TicketListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'ticket_number', header: 'ticket_number', accessorKey: 'ticket_number' },
    { id: 'is_winner', header: 'Is Winner', accessorKey: 'is_winner' },
    hasAccess('lottery', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/lotteries/view/${record.lottery?.id}`}>
              {record.lottery?.name}
            </Link>
          ),
        }
